...
const styles = {
  ...
  avatar: { width: "48px", height: "48px", borderRadius: "50%", background: "#fff", color: "#ff6b35", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "700", fontSize: "20px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" },
  ...
  messageTime: { fontSize: "10px", marginTop: "6px", opacity: 0.7, textAlign: "right" },
